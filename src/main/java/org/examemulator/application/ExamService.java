...
public class ExamService {
	...
	public String getNextExamDynamicNameBy(final Certification certification, final QuestionnaireSet questionnaireSet,
			final Questionnaire questionnaire) {
		...
		if (ObjectUtils.allNotNull(certification, questionnaireSet, questionnaire)) {
			...
			preNameBuilder.append(questionnaireSet.getName()).append(" - ").append(questionnaire.getName())
					.append(" - ");
