...
class RangeSliderUI extends BasicSliderUI {
    ...
    /**
     * Sets the location of the upper thumb, and repaints the slider. This is called when the upper thumb is dragged to repaint the slider. The <code>setThumbLocation()</code> method performs the same
     * task for the lower thumb.
     */
